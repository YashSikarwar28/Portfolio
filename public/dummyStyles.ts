...
//   // Gradient overlay
//   gradientOverlay:
//     "absolute inset-0 bg-linear-to-b from-black/40 via-transparent to-black/60 pointer-events-none",
...
//   calloutCard: {
//     wrapper:
//       "w-full sm:w-auto sm:max-w-md md:max-w-lg lg:max-w-xl rounded-2xl p-3 bg-white/5 border border-white/20 backdrop-blur-sm transition-all hover:bg-white/10 hover:border-white/30",
//     innerContainer:
//       "flex flex-col sm:flex-row items-center sm:justify-between gap-3 sm:gap-4",
//     textContainer: "flex items-center gap-3 min-w-0",
//     icon: "w-5 h-5 text-zinc-300 flex-shrink-0",
...
//   article: {
//     wrapper:
//       "rounded-lg border-zinc-800 bg-zinc-900 shadow-lg overflow-hidden max-w-[720px]",
...
//   spanInline: "inline-block align-middle",
//   spanWithMargin:
//     "inline-block mt-3 md:mt-0 sm:mt-0 lg:mt-0 xl:mt-0 align-middle z-20",
// };
...
//   // Page container
//   pageContainer:
//     "flex min-h-screen w-full justify-center pt-20 bg-zinc-950 px-6 py-12 md:px-12 md:py-20 lg:px-16",
...
//   // Projects grid
//   projectsGrid:
//     "grid grid-cols-1 gap-8 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3",
...
//   // Actions
//   actionsContainer:
//     "mt-6 flex items-center justify-between border-t border-zinc-800 pt-4",
//   actionsLinksContainer: "flex gap-2",
...
//   // Layout and container styles
//   pageContainer:
//     "flex min-h-screen w-full justify-center bg-zinc-950 pt-20 xl:pt-16 px-6 py-12 md:px-12 md:py-20 lg:px-16",
//   contentContainer: "w-full max-w-full",
...
//   // Page container
//   pageContainer:
//     "min-h-screen relative bg-zinc-950 pt-20 px-4 sm:px-6 lg:px-8 pb-20 antialiased",
//   innerContainer: "max-w-6xl mx-auto relative z-10",
