...
export default function Sidebar(): React.ReactElement {
  ...
  // Must be mounted before rendering theme toggle
  ...
  const socials = [
    ...
    },
    {
      ...
      svgPath:
        "M12.071 21.75l-4.097.005 5.068-15.011 4.38-.006-5.351 15.012zm5.351-15.012l-4.22-.007 2.396-6.738 3.99.003-2.166 6.742zM5.965 17.585l2.257-6.276 4.542.007-2.73 7.545-4.069 1.439z",
    },
  ];
  ...
  return (
    <>
      {/* == DESKTOP navbar == */}
      <header className={s.desktopSidebar} aria-label="Desktop Navigation">
        ...
        <Link href="/" className={s.desktopAvatarContainer}>
          ...
          <div>
            <div className={s.desktopName}>{"Yash Sikarwar"}</div>
            <TypingAnimation
        ...
        <nav className={s.navContainer} aria-label="Primary">
      ...
      <div
        className={`${s.mobileOverlay} ${isMobileMenuOpen ? s.mobileOverlayVisible : s.mobileOverlayHidden}`}
        ...
        >
          <div className={s.mobileSidebarHeader}>
            <div className={s.mobileHeaderInner}>
              <div className={s.mobileAvatarContainer}>
                <div className={s.mobileName}>{"Yash Sikarwar"}</div>
              </div>
              <button
                onClick={() => setIsMobileMenuOpen(false)}
          ...
          <div className={s.mobileFooter}>
            ...
            <div className={s.mobileFooterText}>
              <div>{"Made by Yash | © " + new Date().getFullYear()}</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className={s.bottomNavContainer}>
          <div className={s.bottomNavInner}>
            <div className={s.bottomNavBar}>
              ...
              <ThemeToggle className={s.bottomThemeToggle} />
              <div className={s.bottomNavDivider} />
              <button
...
//     {
//       label: "LinkedIn",
//       href: "www.linkedin.com/in/yash-sikarwar-sist",
//       svgPath:
//         "M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z",
//     },
//     {
...
//       {/* == DESKTOP navbar — only on md and above == */}
//       <header className={s.desktopSidebar} aria-label="Desktop Navigation">
//         <Link href="/" className={s.desktopAvatarContainer}>
//           <div className={s.desktopAvatar}>
//             <Image
