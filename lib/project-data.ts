...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "resume-builder",
    description:
      "AI-powered resume creation platform with professional templates",
    detailedDescription:
  ...
  },
  {
    ...
    slug: "task-manager",
    description:
      "Productivity application for task management with team collaboration",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Complete movie booking system with seat selection and payments",
    detailedDescription:
